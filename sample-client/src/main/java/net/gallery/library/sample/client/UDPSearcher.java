...
import net.gallery.library.sample.foo.constants.UDPConstants;
import net.gallery.library.clink.utils.ByteUtils;
...
//        System.out.println("UDPSearcher sendBroadcast started.");
        ...
        // 广播地址
        requestPacket.setAddress(InetAddress.getByName("192.168.220.255"));
        // 设置服务器端口
